...
Color primaryColor = const Color(0xFF0F2341);
Color secondaryColor = const Color(0xFF33BDFE);
Color greenColor = const Color(0xFF4CAF50);
Color redColor = const Color(0xFF9E2033);
Color yellowColor = const Color(0xFFE48320);
Color orangeColor = const Color(0xFFF14035);
Color disableColor = const Color(0xFFB3B3B3);
